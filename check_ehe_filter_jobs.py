...
"""
Create jobfiles for `04-check_ehe_mc_ids.py`.
"""
...
if __name__ == "__main__":
    ...
    job_name = "{}_transient_stacking".format(source_type)
    
    job_dir = os.path.join(PATHS.jobs, "check_{}_mc_ids".format(source_type))
    script = os.path.join(PATHS.repo, "04-check_{}_mc_ids.py".format(source_type))
